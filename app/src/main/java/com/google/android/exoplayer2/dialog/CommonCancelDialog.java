...
public class CommonCancelDialog extends Dialog {
    ...
    public CommonCancelDialog(MainActivity context, View.OnClickListener cancelDialog) {
    ...
    // 클릭버튼이 하나일때 생성자 함수로 클릭이벤트를 받는다.
    public CommonCancelDialog(PlayerSpeedActivity context, View.OnClickListener cancelDialog) {
        super(context, android.R.style.Theme_Translucent_NoTitleBar);
