...
public class CommonMusicStopDialog extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_music_stop_dialog);
    ...
    public CommonMusicStopDialog(MainActivity context, View.OnClickListener cancelDialog) {
    ...
    // 클릭버튼이 하나일때 생성자 함수로 클릭이벤트를 받는다.
    public CommonMusicStopDialog(PlayerSpeedActivity context, View.OnClickListener cancelDialog) {
        super(context, android.R.style.Theme_Translucent_NoTitleBar);
