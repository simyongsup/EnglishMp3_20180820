...
public class CommonTextDialog extends Dialog {
    ...
    public CommonTextDialog(PlayerSpeedActivity context, View.OnClickListener closed) {
    ...
    private void setTextSizeVerUser(int textSizeVerIntParam) {
        Log.d("LOGDA", " textSizeVerIntParam = " + textSizeVerIntParam);
        SharedPreferences sf = contextPop.getSharedPreferences("TextSizeVerUser", 0);
        SharedPreferences.Editor editor = sf.edit();
        editor.putString("TextSizeVerUser", "" + textSizeVerIntParam);
        editor.commit();
    }
}